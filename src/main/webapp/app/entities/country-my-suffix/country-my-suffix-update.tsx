              ...
              <AvForm model={isNew ? {} : countryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="countryCodeLabel" for="countryCode">
                    <Translate contentKey="jhipsterSampleApplicationApp.country.countryCode">Country Code</Translate>
                  </Label>
                  <AvField id="country-my-suffix-countryCode" type="text" name="countryCode" />
                </AvGroup>
                <AvGroup>
                  <Label for="region.id">
